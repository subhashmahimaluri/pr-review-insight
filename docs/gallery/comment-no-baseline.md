...
## ℹ️ Code review baseline recorded
...
<details>
<summary>🎯 Pentest checks (8 total)</summary>
...
<details>
<summary>👯 Duplication (1 total)</summary>
...
**[`src/Component.tsx`](https://github.com/acme/webapp/blob/feedbeef0012/src/Component.tsx)** — 4 findings
...
**[`src/danger.ts`](https://github.com/acme/webapp/blob/feedbeef0012/src/danger.ts)** — 6 findings
...
**[`src/invoices.ts`](https://github.com/acme/webapp/blob/feedbeef0012/src/invoices.ts)** — 1 finding
...
<sub>Reported by **PR Review Insight** · schema v1</sub>
